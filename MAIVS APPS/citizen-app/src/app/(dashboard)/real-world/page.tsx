    ...
    <div className="space-y-8 pb-12">
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="text-lg text-slate-600 mt-4">
          MAIVS is designed to scale into a national security asset. Here is how we transform this simulation into a &quot;Perfect System&quot;.
        </p>
      </div>
      ...
      <div className="bg-indigo-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl">
        <div className="relative z-10">
          <h2 className="text-2xl font-bold mb-4 text-indigo-200">The &quot;Perfect System&quot; Vision</h2>
          <p className="text-indigo-100 leading-relaxed opacity-90 max-w-4xl">
            In a complete deployment, a stolen phone becomes a &quot;paperweight&quot; within seconds of reporting. By synchronizing 
            Telecom Operators, Police Departments, and Identity Authorities into one unified node, we eliminate the 
            economic incentive for mobile theft entirely.
          </p>
        </div>
        <div className="absolute top-0 right-0 -mr-20 -mt-20 opacity-10">
          <GlobeAltIcon className="h-96 w-96" />
        </div>
      </div>
    </div>
  );
