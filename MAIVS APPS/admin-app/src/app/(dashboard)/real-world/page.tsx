    ...
    <div className="space-y-8 pb-12">
      <div className="max-w-3xl">
        ...
        <p className="text-lg text-slate-600 mt-4">
          How Law Enforcement and System Administrators leverage national infrastructure.
        </p>
      </div>
      ...
      <div className="bg-slate-900 rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl">
        <div className="relative z-10">
          <h2 className="text-2xl font-bold mb-4 text-indigo-400">Government Integration Strategy</h2>
          <p className="text-slate-300 leading-relaxed max-w-4xl">
            For Law Enforcement, the goal is &quot;Actionable Intelligence&quot;. A real-world system provides the location of the 
            nearest officer to a flagged resale attempt and allows for legal evidence to be automatically exported 
            from the blockchain-backed ownership registry.
          </p>
        </div>
